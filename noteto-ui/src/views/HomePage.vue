  ...
  <v-container class="top-margin">
        ...
        <v-card-text>
          <div class="d-flex justify-center flex-wrap">
            <div style="height: 50%; width: 50%">
              <v-img
                style="image-rendering: auto; border-radius: 100%"
          ...
          <div class="text-h6 text-lg-subtitle-1 montserrat">
            As the lead developer and founder of Noteto, Tee brings a passion
            for creating innovative and intuitive digital experiences. With more
            than 5 years of experience in software development, Tee is dedicated
            to pushing the boundaries of what's possible and turning creative
            ideas into functional, user-friendly tech solutions for businesses.
          </div>
        </v-card-text>
      </v-card>
    </v-container>
    ...
    >
      ...
      <div>
        ...
        <p class="text-h6 text-lg-h5 grey--text text--darken-1 montserrat">
          Whether tracking sales, requests, or customer data, Noteto offers a
          ...
          <div class="text-h6 text-lg-subtitle-1 montserrat">
            <v-list subheader two-line flat
              ><v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>1 database</v-list-item-title>
                  <v-list-item-subtitle
                    >With 250 GB storage</v-list-item-subtitle
                  >
                </v-list-item-content>
              </v-list-item>
              <v-list-item>
          ...
          <div class="text-h6 text-lg-subtitle-1 montserrat">
            <v-list subheader two-line flat
              ><v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>3 databases</v-list-item-title>
                  <v-list-item-subtitle
                    >With 750 GB storage</v-list-item-subtitle
                  >
                </v-list-item-content>
              </v-list-item>
              <v-list-item>
              ...
              ><v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>Relationship Feature</v-list-item-title>
                  <v-list-item-subtitle
                    >Allows relations between databases</v-list-item-subtitle
                  >
                </v-list-item-content>
              </v-list-item></v-list
            >
          ...
          <div class="text-h6 text-lg-subtitle-1 montserrat">
            <v-list subheader two-line flat
              ><v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>X databases</v-list-item-title>
                  <v-list-item-subtitle>With X GB storage</v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
              <v-list-item>
                <v-list-item-action>
                ...
                <v-list-item-content>
                  <v-list-item-title>X accounts</v-list-item-title>
                  <v-list-item-subtitle
                    >Can be active simultaneously</v-list-item-subtitle
                  >
                </v-list-item-content> </v-list-item
    ...
    <v-container>
      ...
      <v-card v-if="isSubmitted" elevation="0" class="rounded-xl">
        <v-card-text class="text-center">
          <p class="text-h6">
            We have received your information. Our team will contact you.
          </p>
        </v-card-text>
      </v-card>
    </v-container>
