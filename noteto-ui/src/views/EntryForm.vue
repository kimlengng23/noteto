	...
	<v-container class=" white my-2">
		...
		<v-card
			...
			<v-card-text class="d-flex flex-wrap flex-lg-nowrap">
				...
				<v-container
					class="d-flex justify-space-between aligned-center px-0">
					...
					<v-container
						...
						<v-container
							class="text-right py-0 d-flex flex-lg-column">
					...
					<v-slide-group>
						...
						<v-slide-item>
							<v-btn
								...
								:loading="isLoading"
								:disabled="
									!isLoggedIn || !isDirty || !overallFormValid
								">
