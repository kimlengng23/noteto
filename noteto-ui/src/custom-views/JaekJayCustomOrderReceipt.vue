<template>
  <v-container class="white rounded-xl mt-2 pa-0 pa-lg-2">
    <v-card elevation="0">
      <v-card-text>
        <v-row>
          ...
          <v-col>
            <div class="text-lg-h4 text-md-h4 text-h6">Order Invoice</div>
          </v-col>
        </v-row>
        <v-row>
          <v-col>
            ...
            <v-row
              class="green white--text rounded-xl"
        ...
        <v-row>
          <v-col
            ><div class="ttext-lg-h6 text-md-h6 text-subtitle-2 label">
              Item List
            </div></v-col
          >
        </v-row>
              ...
              <tbody>
                <tr v-for="(item, idx) in itemList" :key="idx">
                  ...
                  >
                    ...
                    {{
                      (
                        item.itemUnitPrice * (1 + item.itemTax / 100.0) +
                        0.00001
                      ).toFixed(2)
                    }}
                  </td>
                ...
                <tr>
                  <td class="text-caption text-md-body-2 text-lg-subtitle-2">
                    <div>Fee {{ entry.collectingFee }} %</div>
                  </td>
                  <td></td>
                  <td></td>
